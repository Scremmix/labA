...
public class DatiInserimentoPopup extends javax.swing.JPanel {
    ...
    public DatiInserimentoPopup() {
        System.out.println("Aiuuuudo");
        initComponents();
        this.setVisible(true);
        gruppoTipiValori.add(ventoRB);
        gruppoTipiValori.add(umiditaRB);
        gruppoTipiValori.add(pressioneRB);
        gruppoTipiValori.add(temperaturaRB);
        gruppoTipiValori.add(precipitazioniRB);
        gruppoTipiValori.add(altitudineRB);
        gruppoTipiValori.add(massaRB);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new DatiInserimentoPopup().setVisible(true);
        });
    }
